...
public class GeneralServicesActivity extends AppCompatActivity implements
    ...
    private void loadSomeData() {
        ...
        Child country = new Child("মোঃ আশিকুর রহমান", "ডেপুটি", "01816864529", "ashikur.pstu@yahoo.com");
        countryList.add(country);


        Parent continent = new Parent("শিক্ষা ও বৃত্তি শাখা", countryList);
